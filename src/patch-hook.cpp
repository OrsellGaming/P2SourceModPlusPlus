...
bool Patches::EnablePatches()
{
    try
    {
        ...
        Memory::ReplacePattern("server", Signatures::CPortal_Player_NotifySystemEvent_EventTeleportUserID, Signatures::CPortal_Player_NotifySystemEvent_EventTeleportUserID_Patch);
        ...
        Memory::ReplacePattern("vscript", Signatures::SQVM_RuntimeTimeout, Signatures::SQVM_RuntimeTimeout_Patch);
        ...
        Memory::ReplacePattern("server", Signatures::CEnvProjectedTexture_EnforceSingleProjectionRules_Loop, Signatures::CEnvProjectedTexture_EnforceSingleProjectionRules_Loop_Patch);

        // CClientShadowMgr::CalculateRenderTargetsAndSizes | Increase the projected texture limit from 1 -> 8
        Memory::ReplacePattern("client", Signatures::CClientShadowMgr_CalculateRenderTargetsAndSizes_PtexLimit, Signatures::CClientShadowMgr_CalculateRenderTargetsAndSizes_PtexLimit_Patch);
        ...
        Memory::ReplacePattern("client", Signatures::CClientShadowMgr_CalculateRenderTargetsAndSizes_ShadowRes, Signatures::CClientShadowMgr_CalculateRenderTargetsAndSizes_ShadowRes_Patch);
